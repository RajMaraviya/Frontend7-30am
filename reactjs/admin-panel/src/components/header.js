    ...
    <div>
      <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <Link class="navbar-brand brand-logo-mini" href="index.html"><img src="img/logo-mini.svg" alt="logo" /></Link>
        </div>
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
              <Link class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="#">+ Create New Project</Link>
            ...
            <li class="nav-item dropdown border-left">
              <Link class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <li class="nav-item dropdown border-left">
              <Link class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-bs-toggle="dropdown">
            ...
            <li class="nav-item dropdown">
              <Link class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                ...
                <div class="dropdown-divider"></div>
                <Link class="dropdown-item preview-item" to='/admin-login'>
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-dark rounded-circle">
