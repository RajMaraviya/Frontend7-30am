...
export default function UpdateProduct() {
    ...
    //edit data inside UpdateCategory component with get method
    useEffect(() => {
        axios.get(`https://project-data-8dy4.onrender.com/product/${id}`)
            .then((response) => {
    ...
    const UpdateProductHandler = () => {
        ...
        axios.put(`https://project-data-8dy4.onrender.com/product/${id}`, update)
            .then((response) => {
                Swal.fire({
                    icon: 'success',
